...
public class TwitterAuthorization {
	...
	public TwitterNetwork tNetwork;

	public TwitterAuthorization(Context newContext) {
		context = newContext;
	...
	/**
	 * Given the authorization URL, returns the user ID.
	 * 
	 * @param url
	...
	public boolean isTwitterLoggedIn() {
		return mySP.getBoolean(PREF_KEY_TWITTER_LOGIN, false);
	}
